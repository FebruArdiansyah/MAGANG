...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark shadow sticky-top" style="background: linear-gradient(to right, #0A0F2C, #1E3A8A);">
        <div class="container-fluid px-3 d-flex align-items-center justify-content-between">
            ...
            <a class="navbar-brand d-flex align-items-center" href="/">
                <img src="{{ asset('assets/logo.png') }}" alt="Logo" width="36" class="me-2">
    ...
    <!-- FOOTER -->
    <footer class="text-white py-5 mt-5" style="background-color: #0A0F2C;">
        <div class="container">
            <div class="row g-4">
                <div class="col-md-3">
                    <h5>TAUTAN</h5>
                ...
                <div class="col-md-3">
                    <div class="d-flex gap-2 mb-2">
                        <img src="{{ asset('assets/logo.png') }}" height="40">
                        <img src="{{ asset('assets/bpd.png') }}" height="40">
                    </div>
